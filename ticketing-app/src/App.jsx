...
import { faGear, faCubesStacked, faGlobe, faShield, faBuilding, faChevronDown, faCheck, faAngleUp, faChalkboardUser, faArrowRightFromBracket } from '@fortawesome/free-solid-svg-icons';

library.add(faComments, faCircleUser, faGlobe, faCubesStacked, faBell, faHouse, faChevronDown, faChalkboardUser, faAngleUp, faPenToSquare, faArrowRightFromBracket, faSquarePlus, faTrashCan, faUser, faIdBadge, faGear, faShield, faBuilding);
