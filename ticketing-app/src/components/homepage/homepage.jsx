            ...
            return (
                <>
                    <div className='homepage-link-container'>
                        ...
                        <div className='homepage-link-item' onClick={() => navigate('/settings')}>
            ...
            return (
                <>
                    <div className='homepage-link-container'>
                        ...
                        <div className='homepage-link-item' onClick={() => navigate('/admin-centre')}>
            ...
            return (
                <>
                    <div className='homepage-link-container'>
                        ...
                        <div className='homepage-link-item' onClick={() => navigate('/manager-centre')}>
